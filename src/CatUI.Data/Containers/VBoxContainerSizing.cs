...
namespace CatUI.Data.Containers
{
    ...
    {
        /// <summary>
        /// Controls the growth factor of the element. The growth factor is the portion of the VBoxContainer that is
        /// allocated to this element that is left after all non-growing elements' minimum size (the ones with this
        /// property set to 0, the default value) are subtracted from the total height of the VBoxContainer. See
        ...
        /// <remarks>
        /// <para>
        /// The remaining "unallocated space" of the VBoxContainer is its height without the heights of non-growing
        /// element's size. All the growing elements' VerticalGrow are summed, then each element gets the corresponding
        /// amount of space.
        /// </para>
        /// <para>
        ...
        /// </remarks>
        /// <example>
        /// VBoxContainer has a height of 1000dp. The summed heights of non-growing elements is 400dp, meaning the
        /// VBoxContainer's unallocated space is 600dp. There are 3 growing elements, two with VerticalGrow of 1
        /// and one with VerticalGrow of 2. A "sector" is 150dp (600 / 4), as the sum of the growth factors is 4.
