...
namespace CatUI.Data.Containers
{
    ...
    {
        /// <summary>
        /// Controls the growth factor of the element. The growth factor is the portion of the HBoxContainer that is
        /// allocated to this element that is left after all non-growing elements' minimum size (the ones with this
        /// property set to 0, the default value) are subtracted from the total width of the HBoxContainer. See
        ...
        /// <remarks>
        /// <para>
        /// The remaining "unallocated space" of the HBoxContainer is its width without the widths of non-growing element's
        /// minimum size. All the growing elements' HorizontalGrow are summed, then each element gets the corresponding
        /// amount of space.
        /// </para>
        /// <para>
        ...
        /// </remarks>
        /// <example>
        /// HBoxContainer has a width of 1000dp. The summed widths of non-growing elements is 400dp, meaning the
        /// HBoxContainer's unallocated space is 600dp. There are 3 growing elements, two with HorizontalGrow of 1
        /// and one with HorizontalGrow of 2. A "sector" is 150dp (600 / 4), as the sum of the growth factors is 4.
