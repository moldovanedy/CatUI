...
public class CheckBox : BaseButton, IToggleable
{
    ...
    public ObservableProperty<CheckBoxState> ValueProperty
    {
        get => _valueProperty;
        set => _valueProperty.BindBidirectional(value);
    }

    private readonly ObservableProperty<CheckBoxState> _valueProperty = new(CheckBoxState.Unchecked);
    ...
    /// <summary>
    /// Creates a new checkbox with <see cref="TextElement"/> as a new <see cref="Label"/> with the given
    /// properties.
    /// </summary>
