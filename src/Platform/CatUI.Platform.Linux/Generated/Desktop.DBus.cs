//NOTE: This is auto-generated using Tmds.Dbus.Tool with the following command:
//dotnet dbus codegen --protocol-api --bus session --service org.freedesktop.portal.Desktop
//The file was modified to resolve all compiler warnings, but some ReSharper specific warnings and suggestions will
//still be shown. Do not modify this manually unless it needs to solve a serious issue or a compiler warning
...
namespace Desktop.DBus
{
    ...
    internal sealed record InhibitProperties
    {
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class Inhibit : DesktopObject
    {
        ...
        public Task<ObjectPath> InhibitAsync(string window, uint flags, Dictionary<string, VariantValue> options)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_o(m, (DesktopObject)s!), this);
        ...
        public ValueTask<IDisposable> WatchStateChangedAsync(
            Action<Exception?, (ObjectPath SessionHandle, Dictionary<string, VariantValue> State)> handler,
            bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        {
            return WatchSignalAsync(Service.Destination, __Interface, Path, "StateChanged",
                (Message m, object? s) => ReadMessage_oaesv(m, (DesktopObject)s!), handler, emitOnCapturedContext,
                flags);
        }

        public Task<uint> GetVersionAsync()
        {
            return Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "version"),
                (Message m, object? s) => ReadMessage_v_u(m, (DesktopObject)s!), this);
        }

        public Task<InhibitProperties> GetPropertiesAsync()
        {
            return Connection.CallMethodAsync(CreateGetAllPropertiesMessage(__Interface),
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), this);
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<InhibitProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<InhibitProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                return new PropertyChanges<InhibitProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record BackgroundProperties
    {
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class Background : DesktopObject
    {
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<BackgroundProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<BackgroundProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<BackgroundProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record LocationProperties
    {
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class Location : DesktopObject
    {
        ...
        public Task<ObjectPath> StartAsync(ObjectPath sessionHandle, string parentWindow,
        ...
        public ValueTask<IDisposable> WatchLocationUpdatedAsync(
            Action<Exception?, (ObjectPath SessionHandle, Dictionary<string, VariantValue> Location)> handler,
            bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        {
            return WatchSignalAsync(Service.Destination, __Interface, Path, "LocationUpdated",
                (Message m, object? s) => ReadMessage_oaesv(m, (DesktopObject)s!), handler, emitOnCapturedContext,
                flags);
        }
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<LocationProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<LocationProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<LocationProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record NotificationProperties
    {
        public Dictionary<string, VariantValue> SupportedOptions { get; set; } = default!;
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class Notification : DesktopObject
    {
        ...
        public ValueTask<IDisposable> WatchActionInvokedAsync(
            Action<Exception?, (string Id, string Action, VariantValue[] Parameter)> handler,
            bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        {
            return WatchSignalAsync(Service.Destination, __Interface, Path, "ActionInvoked",
                (Message m, object? s) => ReadMessage_ssav(m, (DesktopObject)s!), handler, emitOnCapturedContext,
                flags);
        }

        public Task<Dictionary<string, VariantValue>> GetSupportedOptionsAsync()
        {
            return Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "SupportedOptions"),
                (Message m, object? s) => ReadMessage_v_aesv(m, (DesktopObject)s!), this);
        }
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<NotificationProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<NotificationProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<NotificationProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record ScreenshotProperties
    {
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class Screenshot : DesktopObject
    {
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<ScreenshotProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<ScreenshotProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<ScreenshotProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record RegistryProperties
    {
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class Registry : DesktopObject
    {
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<RegistryProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<RegistryProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<RegistryProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record AccountProperties
    {
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class Account : DesktopObject
    {
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<AccountProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<AccountProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<AccountProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record NetworkMonitorProperties
    {
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class NetworkMonitor : DesktopObject
    {
        ...
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_b(m, (DesktopObject)s!), this);
        ...
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_u(m, (DesktopObject)s!), this);
        ...
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_aesv(m, (DesktopObject)s!), this);
        ...
        public ValueTask<IDisposable> WatchChangedAsync(Action<Exception?> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return WatchSignalAsync(Service.Destination, __Interface, Path, "changed", handler, emitOnCapturedContext,
                flags);
        }
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<NetworkMonitorProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<NetworkMonitorProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<NetworkMonitorProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record PrintProperties
    {
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class Print : DesktopObject
    {
        ...
        public Task<ObjectPath> PreparePrintAsync(string parentWindow, string title,
            Dictionary<string, VariantValue> settings, Dictionary<string, VariantValue> pageSetup,
            Dictionary<string, VariantValue> options)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_o(m, (DesktopObject)s!), this);
        ...
        public Task<ObjectPath> PrintAsync(string parentWindow, string title,
            System.Runtime.InteropServices.SafeHandle fd, Dictionary<string, VariantValue> options)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_o(m, (DesktopObject)s!), this);
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<PrintProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<PrintProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<PrintProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record SettingsProperties
    {
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class Settings : DesktopObject
    {
        ...
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_aesaesv(m, (DesktopObject)s!), this);
        ...
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_v(m, (DesktopObject)s!), this);
        ...
        public ValueTask<IDisposable> WatchSettingChangedAsync(
            Action<Exception?, (string Namespace, string Key, VariantValue Value)> handler,
            bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        {
            return WatchSignalAsync(Service.Destination, __Interface, Path, "SettingChanged",
                (Message m, object? s) => ReadMessage_ssv(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
        }
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<SettingsProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<SettingsProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<SettingsProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record GameModeProperties
    {
        public bool Active { get; set; } = default!;
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class GameMode : DesktopObject
    {
        ...
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_i(m, (DesktopObject)s!), this);
        ...
        public Task<int> QueryStatusByPIDFdAsync(System.Runtime.InteropServices.SafeHandle target,
            System.Runtime.InteropServices.SafeHandle requester)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_i(m, (DesktopObject)s!), this);
        ...
        public Task<int> RegisterGameByPIDFdAsync(System.Runtime.InteropServices.SafeHandle target,
            System.Runtime.InteropServices.SafeHandle requester)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_i(m, (DesktopObject)s!), this);
        ...
        public Task<int> UnregisterGameByPIDFdAsync(System.Runtime.InteropServices.SafeHandle target,
            System.Runtime.InteropServices.SafeHandle requester)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_i(m, (DesktopObject)s!), this);
        ...
        {
            return Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "Active"),
                (Message m, object? s) => ReadMessage_v_b(m, (DesktopObject)s!), this);
        }
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<GameModeProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<GameModeProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<GameModeProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record RemoteDesktopProperties
    {
        public uint AvailableDeviceTypes { get; set; } = default!;
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class RemoteDesktop : DesktopObject
    {
        ...
        public Task NotifyPointerMotionAsync(ObjectPath sessionHandle, Dictionary<string, VariantValue> options,
            double dx, double dy)
        {
            return Connection.CallMethodAsync(CreateMessage());
        ...
        public Task NotifyPointerMotionAbsoluteAsync(ObjectPath sessionHandle, Dictionary<string, VariantValue> options,
        ...
        public Task NotifyPointerButtonAsync(ObjectPath sessionHandle, Dictionary<string, VariantValue> options,
            int button, uint state)
        {
            return Connection.CallMethodAsync(CreateMessage());
        ...
        public Task NotifyPointerAxisAsync(ObjectPath sessionHandle, Dictionary<string, VariantValue> options,
            double dx, double dy)
        {
            return Connection.CallMethodAsync(CreateMessage());
        ...
        public Task NotifyPointerAxisDiscreteAsync(ObjectPath sessionHandle, Dictionary<string, VariantValue> options,
            uint axis, int steps)
        {
            return Connection.CallMethodAsync(CreateMessage());
        ...
        public Task NotifyKeyboardKeycodeAsync(ObjectPath sessionHandle, Dictionary<string, VariantValue> options,
            int keycode, uint state)
        {
            return Connection.CallMethodAsync(CreateMessage());
        ...
        public Task NotifyKeyboardKeysymAsync(ObjectPath sessionHandle, Dictionary<string, VariantValue> options,
            int keysym, uint state)
        {
            return Connection.CallMethodAsync(CreateMessage());
        ...
        public Task NotifyTouchDownAsync(ObjectPath sessionHandle, Dictionary<string, VariantValue> options,
            uint stream, uint slot, double x, double y)
        {
            return Connection.CallMethodAsync(CreateMessage());
        ...
        public Task NotifyTouchMotionAsync(ObjectPath sessionHandle, Dictionary<string, VariantValue> options,
            uint stream, uint slot, double x, double y)
        {
            return Connection.CallMethodAsync(CreateMessage());
        ...
        public Task<System.Runtime.InteropServices.SafeHandle> ConnectToEISAsync(ObjectPath sessionHandle,
            Dictionary<string, VariantValue> options)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_h(m, (DesktopObject)s!), this);
        ...
        {
            return Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "AvailableDeviceTypes"),
                (Message m, object? s) => ReadMessage_v_u(m, (DesktopObject)s!), this);
        }
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<RemoteDesktopProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<RemoteDesktopProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<RemoteDesktopProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record MemoryMonitorProperties
    {
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class MemoryMonitor : DesktopObject
    {
        ...
        public ValueTask<IDisposable> WatchLowMemoryWarningAsync(Action<Exception?, byte> handler,
            bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        {
            return WatchSignalAsync(Service.Destination, __Interface, Path, "LowMemoryWarning",
                (Message m, object? s) => ReadMessage_y(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
        }
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<MemoryMonitorProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<MemoryMonitorProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<MemoryMonitorProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record OpenURIProperties
    {
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class OpenURI : DesktopObject
    {
        ...
        public Task<ObjectPath> OpenFileAsync(string parentWindow, System.Runtime.InteropServices.SafeHandle fd,
            Dictionary<string, VariantValue> options)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_o(m, (DesktopObject)s!), this);
        ...
        public Task<ObjectPath> OpenDirectoryAsync(string parentWindow, System.Runtime.InteropServices.SafeHandle fd,
            Dictionary<string, VariantValue> options)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_o(m, (DesktopObject)s!), this);
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<OpenURIProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<OpenURIProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<OpenURIProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record RealtimeProperties
    {
    ...
    internal sealed partial class Realtime : DesktopObject
    {
        ...
        {
            return Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "MaxRealtimePriority"),
                (Message m, object? s) => ReadMessage_v_i(m, (DesktopObject)s!), this);
        }

        public Task<int> GetMinNiceLevelAsync()
        {
            return Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "MinNiceLevel"),
                (Message m, object? s) => ReadMessage_v_i(m, (DesktopObject)s!), this);
        }

        public Task<long> GetRTTimeUSecMaxAsync()
        {
            return Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "RTTimeUSecMax"),
                (Message m, object? s) => ReadMessage_v_x(m, (DesktopObject)s!), this);
        }
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<RealtimeProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<RealtimeProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<RealtimeProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record SecretProperties
    {
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class Secret : DesktopObject
    {
        ...
        public Task<ObjectPath> RetrieveSecretAsync(System.Runtime.InteropServices.SafeHandle fd,
            Dictionary<string, VariantValue> options)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_o(m, (DesktopObject)s!), this);
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<SecretProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<SecretProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<SecretProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record CameraProperties
    {
        public bool IsCameraPresent { get; set; } = default!;
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class Camera : DesktopObject
    {
        ...
        public Task<System.Runtime.InteropServices.SafeHandle> OpenPipeWireRemoteAsync(
            Dictionary<string, VariantValue> options)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_h(m, (DesktopObject)s!), this);
        ...
        {
            return Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "IsCameraPresent"),
                (Message m, object? s) => ReadMessage_v_b(m, (DesktopObject)s!), this);
        }
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<CameraProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<CameraProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<CameraProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record InputCaptureProperties
    {
        public uint SupportedCapabilities { get; set; } = default!;
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class InputCapture : DesktopObject
    {
        ...
        public Task<ObjectPath> SetPointerBarriersAsync(ObjectPath sessionHandle,
            Dictionary<string, VariantValue> options, Dictionary<string, VariantValue>[] barriers, uint zoneSet)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_o(m, (DesktopObject)s!), this);
        ...
        public ValueTask<IDisposable> WatchDisabledAsync(
            Action<Exception?, (ObjectPath SessionHandle, Dictionary<string, VariantValue> Options)> handler,
            bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        {
            return WatchSignalAsync(Service.Destination, __Interface, Path, "Disabled",
                (Message m, object? s) => ReadMessage_oaesv(m, (DesktopObject)s!), handler, emitOnCapturedContext,
                flags);
        }
        ...
        public ValueTask<IDisposable> WatchActivatedAsync(
            ...
            bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        {
            return WatchSignalAsync(Service.Destination, __Interface, Path, "Activated",
                (Message m, object? s) => ReadMessage_oaesv(m, (DesktopObject)s!), handler, emitOnCapturedContext,
                flags);
        }
        ...
        public ValueTask<IDisposable> WatchDeactivatedAsync(
            ...
            bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        {
            return WatchSignalAsync(Service.Destination, __Interface, Path, "Deactivated",
                (Message m, object? s) => ReadMessage_oaesv(m, (DesktopObject)s!), handler, emitOnCapturedContext,
                flags);
        }

        public ValueTask<IDisposable> WatchZonesChangedAsync(
            Action<Exception?, (ObjectPath SessionHandle, Dictionary<string, VariantValue> Options)> handler,
            bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        {
            return WatchSignalAsync(Service.Destination, __Interface, Path, "ZonesChanged",
                (Message m, object? s) => ReadMessage_oaesv(m, (DesktopObject)s!), handler, emitOnCapturedContext,
                flags);
        }
        ...
        {
            return Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "SupportedCapabilities"),
                (Message m, object? s) => ReadMessage_v_u(m, (DesktopObject)s!), this);
        }
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<InputCaptureProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<InputCaptureProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<InputCaptureProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record GlobalShortcutsProperties
    {
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class GlobalShortcuts : DesktopObject
    {
        ...
        public Task<ObjectPath> BindShortcutsAsync(ObjectPath sessionHandle,
            (string, Dictionary<string, VariantValue>)[] shortcuts, string parentWindow,
            Dictionary<string, VariantValue> options)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_o(m, (DesktopObject)s!), this);
        ...
        public ValueTask<IDisposable> WatchActivatedAsync(
            Action<Exception?, (ObjectPath SessionHandle, string ShortcutId, ulong Timestamp,
                Dictionary<string, VariantValue> Options)> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return WatchSignalAsync(Service.Destination, __Interface, Path, "Activated",
                (Message m, object? s) => ReadMessage_ostaesv(m, (DesktopObject)s!), handler, emitOnCapturedContext,
                flags);
        }
        ...
        public ValueTask<IDisposable> WatchShortcutsChangedAsync(
            Action<Exception?, (ObjectPath SessionHandle, (string, Dictionary<string, VariantValue>)[] Shortcuts)>
                handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        {
            return WatchSignalAsync(Service.Destination, __Interface, Path, "ShortcutsChanged",
                (Message m, object? s) => ReadMessage_oarsaesvz(m, (DesktopObject)s!), handler, emitOnCapturedContext,
                flags);
        }
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<GlobalShortcutsProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<GlobalShortcutsProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<GlobalShortcutsProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record PowerProfileMonitorProperties
    {
        public bool PowerSaverEnabled { get; set; } = default!;
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class PowerProfileMonitor : DesktopObject
    {
        ...
        {
            return Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "power-saver-enabled"),
                (Message m, object? s) => ReadMessage_v_b(m, (DesktopObject)s!), this);
        }
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<PowerProfileMonitorProperties>> handler,
            bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<PowerProfileMonitorProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<PowerProfileMonitorProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record DynamicLauncherProperties
    {
        public uint SupportedLauncherTypes { get; set; } = default!;
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class DynamicLauncher : DesktopObject
    {
        ...
        public Task InstallAsync(string token, string desktopFileId, string desktopEntry,
            Dictionary<string, VariantValue> options)
        {
            return Connection.CallMethodAsync(CreateMessage());
        ...
        public Task<ObjectPath> PrepareInstallAsync(string parentWindow, string name, VariantValue iconV,
            Dictionary<string, VariantValue> options)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_o(m, (DesktopObject)s!), this);
        ...
        public Task<string> RequestInstallTokenAsync(string name, VariantValue iconV,
            Dictionary<string, VariantValue> options)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_s(m, (DesktopObject)s!), this);
        ...
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_vsu(m, (DesktopObject)s!), this);
        ...
        {
            return Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "SupportedLauncherTypes"),
                (Message m, object? s) => ReadMessage_v_u(m, (DesktopObject)s!), this);
        }
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<DynamicLauncherProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<DynamicLauncherProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<DynamicLauncherProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record ScreenCastProperties
    {
    ...
    internal sealed partial class ScreenCast : DesktopObject
    {
        ...
        public Task<System.Runtime.InteropServices.SafeHandle> OpenPipeWireRemoteAsync(ObjectPath sessionHandle,
            Dictionary<string, VariantValue> options)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_h(m, (DesktopObject)s!), this);
        ...
        {
            return Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "AvailableSourceTypes"),
                (Message m, object? s) => ReadMessage_v_u(m, (DesktopObject)s!), this);
        }

        public Task<uint> GetAvailableCursorModesAsync()
        {
            return Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "AvailableCursorModes"),
                (Message m, object? s) => ReadMessage_v_u(m, (DesktopObject)s!), this);
        }
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<ScreenCastProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<ScreenCastProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<ScreenCastProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record EmailProperties
    {
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class Email : DesktopObject
    {
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<EmailProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<EmailProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<EmailProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record TrashProperties
    {
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class Trash : DesktopObject
    {
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<TrashProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<TrashProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<TrashProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record ProxyResolverProperties
    {
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class ProxyResolver : DesktopObject
    {
        ...
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_as(m, (DesktopObject)s!), this);
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<ProxyResolverProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<ProxyResolverProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<ProxyResolverProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed record FileChooserProperties
    {
        public uint Version { get; set; } = default!;
    }

    internal sealed partial class FileChooser : DesktopObject
    {
        ...
        public Task<ObjectPath> OpenFileAsync(string parentWindow, string title,
            Dictionary<string, VariantValue> options)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_o(m, (DesktopObject)s!), this);
        ...
        public Task<ObjectPath> SaveFileAsync(string parentWindow, string title,
            Dictionary<string, VariantValue> options)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_o(m, (DesktopObject)s!), this);
        ...
        public Task<ObjectPath> SaveFilesAsync(string parentWindow, string title,
            Dictionary<string, VariantValue> options)
        {
            return Connection.CallMethodAsync(CreateMessage(),
                (Message m, object? s) => ReadMessage_o(m, (DesktopObject)s!), this);
        ...
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(
            Action<Exception?, PropertyChanges<FileChooserProperties>> handler, bool emitOnCapturedContext = true,
            ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface,
                (Message m, object? s) => ReadMessage(m, (DesktopObject)s!), handler, emitOnCapturedContext, flags);
            ...
            static PropertyChanges<FileChooserProperties> ReadMessage(Message message, DesktopObject _)
            {
                ...
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<FileChooserProperties>(ReadProperties(ref reader, changed),
                    ReadInvalidated(ref reader), changed.ToArray());
            }
    ...
    internal sealed partial class DesktopService
    {
        ...
        public Inhibit CreateInhibit(ObjectPath path)
        {
            return new Inhibit(this, path);
        }

        public Background CreateBackground(ObjectPath path)
        {
            return new Background(this, path);
        }

        public Location CreateLocation(ObjectPath path)
        {
            return new Location(this, path);
        }

        public Notification CreateNotification(ObjectPath path)
        {
            return new Notification(this, path);
        }

        public Screenshot CreateScreenshot(ObjectPath path)
        {
            return new Screenshot(this, path);
        }

        public Registry CreateRegistry(ObjectPath path)
        {
            return new Registry(this, path);
        }

        public Account CreateAccount(ObjectPath path)
        {
            return new Account(this, path);
        }

        public NetworkMonitor CreateNetworkMonitor(ObjectPath path)
        {
            return new NetworkMonitor(this, path);
        }

        public Print CreatePrint(ObjectPath path)
        {
            return new Print(this, path);
        }

        public Settings CreateSettings(ObjectPath path)
        {
            return new Settings(this, path);
        }

        public GameMode CreateGameMode(ObjectPath path)
        {
            return new GameMode(this, path);
        }

        public RemoteDesktop CreateRemoteDesktop(ObjectPath path)
        {
            return new RemoteDesktop(this, path);
        }

        public MemoryMonitor CreateMemoryMonitor(ObjectPath path)
        {
            return new MemoryMonitor(this, path);
        }

        public OpenURI CreateOpenURI(ObjectPath path)
        {
            return new OpenURI(this, path);
        }

        public Realtime CreateRealtime(ObjectPath path)
        {
            return new Realtime(this, path);
        }

        public Secret CreateSecret(ObjectPath path)
        {
            return new Secret(this, path);
        }

        public Camera CreateCamera(ObjectPath path)
        {
            return new Camera(this, path);
        }

        public InputCapture CreateInputCapture(ObjectPath path)
        {
            return new InputCapture(this, path);
        }

        public GlobalShortcuts CreateGlobalShortcuts(ObjectPath path)
        {
            return new GlobalShortcuts(this, path);
        }

        public PowerProfileMonitor CreatePowerProfileMonitor(ObjectPath path)
        {
            return new PowerProfileMonitor(this, path);
        }

        public DynamicLauncher CreateDynamicLauncher(ObjectPath path)
        {
            return new DynamicLauncher(this, path);
        }

        public ScreenCast CreateScreenCast(ObjectPath path)
        {
            return new ScreenCast(this, path);
        }

        public Email CreateEmail(ObjectPath path)
        {
            return new Email(this, path);
        }

        public Trash CreateTrash(ObjectPath path)
        {
            return new Trash(this, path);
        }

        public ProxyResolver CreateProxyResolver(ObjectPath path)
        {
            return new ProxyResolver(this, path);
        }

        public FileChooser CreateFileChooser(ObjectPath path)
        {
            return new FileChooser(this, path);
        }
    }
    ...
    internal class DesktopObject
    {
        ...
        public ValueTask<IDisposable> WatchSignalAsync<TArg>(string sender, string @interface, ObjectPath path,
            string signal, MessageValueReader<TArg> reader, Action<Exception?, TArg> handler,
        ...
        public ValueTask<IDisposable> WatchSignalAsync(string sender, string @interface, ObjectPath path, string signal,
            Action<Exception?> handler, bool emitOnCapturedContext, ObserverFlags flags)
        {
            var rule = new MatchRule
            {
                Type = MessageType.Signal,
            ...
            return Connection.AddMatchAsync<object>(rule, (Message message, object? state) => null!,
                (Exception? ex, object v, object? rs, object? hs) => ((Action<Exception?>)hs!).Invoke(ex), this,
                handler, emitOnCapturedContext, flags);
        }
        ...
        protected static (ObjectPath, Dictionary<string, VariantValue>) ReadMessage_oaesv(Message message,
            DesktopObject _)
        {
            Reader reader = message.GetBodyReader();
            ObjectPath arg0 = reader.ReadObjectPath();
            Dictionary<string, VariantValue> arg1 = reader.ReadDictionaryOfStringToVariantValue();
            return (arg0, arg1);
        }
        ...
        protected static (string, string, VariantValue[]) ReadMessage_ssav(Message message, DesktopObject _)
        {
            ...
            VariantValue[] arg2 = reader.ReadArrayOfVariantValue();
        ...
        protected static Dictionary<string, Dictionary<string, VariantValue>> ReadMessage_aesaesv(Message message,
            DesktopObject _)
        {
            Reader reader = message.GetBodyReader();
        ...
        protected static (string, string, VariantValue) ReadMessage_ssv(Message message, DesktopObject _)
        {
            ...
            string arg0 = reader.ReadString();
            string arg1 = reader.ReadString();
            VariantValue arg2 = reader.ReadVariantValue();
            return (arg0, arg1, arg2);
        }
        ...
        protected static System.Runtime.InteropServices.SafeHandle ReadMessage_h(Message message, DesktopObject _)
        {
            Reader reader = message.GetBodyReader();
            return
                reader.ReadHandle<Microsoft.Win32.SafeHandles.SafeFileHandle>() ??
                throw new Exception("Tmds.Dbus overwrite: a safe file handle was null");
        }
        ...
        protected static (ObjectPath, string, ulong, Dictionary<string, VariantValue>) ReadMessage_ostaesv(
            Message message, DesktopObject _)
        {
            Reader reader = message.GetBodyReader();
            ObjectPath arg0 = reader.ReadObjectPath();
            string arg1 = reader.ReadString();
            ulong arg2 = reader.ReadUInt64();
            Dictionary<string, VariantValue> arg3 = reader.ReadDictionaryOfStringToVariantValue();
            return (arg0, arg1, arg2, arg3);
        }

        protected static (ObjectPath, (string, Dictionary<string, VariantValue>)[]) ReadMessage_oarsaesvz(
            Message message, DesktopObject _)
        {
            Reader reader = message.GetBodyReader();
            ObjectPath arg0 = reader.ReadObjectPath();
            (string, Dictionary<string, VariantValue>)[] arg1 = ReadType_arsaesvz(ref reader);
            return (arg0, arg1);
        }
        ...
        {
            Reader reader = message.GetBodyReader();
            VariantValue arg0 = reader.ReadVariantValue();
            string arg1 = reader.ReadString();
            uint arg2 = reader.ReadUInt32();
            return (arg0, arg1, arg2);
        }
        ...
        protected static Dictionary<string, Dictionary<string, VariantValue>> ReadType_aesaesv(ref Reader reader)
        {
            ...
            while (reader.HasNext(dictEnd))
            {
                ...
                Dictionary<string, VariantValue> value = reader.ReadDictionaryOfStringToVariantValue();
        ...
        protected static void WriteType_aaesv(ref MessageWriter writer, Dictionary<string, VariantValue>[] value)
        {
            ...
            foreach (Dictionary<string, VariantValue> item in value)
            {
        ...
        protected static void WriteType_arsaesvz(ref MessageWriter writer,
            (string, Dictionary<string, VariantValue>)[] value)
        {
            ArrayStart arrayStart = writer.WriteArrayStart(DBusType.Struct);
            foreach ((string, Dictionary<string, VariantValue>) item in value)
            {
        ...
        protected static void WriteType_rsaesvz(ref MessageWriter writer,
            (string, Dictionary<string, VariantValue>) value)
        {
    ...
    internal sealed class PropertyChanges<TProperties>
    {
